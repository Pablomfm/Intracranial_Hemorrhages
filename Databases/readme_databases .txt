...
------------
	...
	'ICH_database_complete.xlsx' (not available in this repository) ---->
	 ----> 'ICH_database_complete_pseudoanonymized.xlsx'/ICH_database_complete_pseudoanonymized.csv (not available in this repository) ---->
	 ----> 'ICH_database_pseudoanonymized_nonredudant.csv'(not available in this repository) ---->
